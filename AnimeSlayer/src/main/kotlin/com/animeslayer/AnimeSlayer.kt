...
class AnimeSlayer : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        // جميع أنواع الأنمي بناءً على HTML
        "$mainUrl/anime/?genre%5B%5D=action" to "Action",
        "$mainUrl/anime/?genre%5B%5D=adult-cast" to "Adult Cast",
        "$mainUrl/anime/?genre%5B%5D=adventure" to "Adventure",
        "$mainUrl/anime/?genre%5B%5D=anthropomorphic" to "Anthropomorphic",
        "$mainUrl/anime/?genre%5B%5D=avant-garde" to "Avant Garde",
        "$mainUrl/anime/?genre%5B%5D=award-winning" to "Award Winning",
        "$mainUrl/anime/?genre%5B%5D=boys-love" to "Boys Love",
        "$mainUrl/anime/?genre%5B%5D=cgdct" to "CGDCT",
        "$mainUrl/anime/?genre%5B%5D=childcare" to "Childcare",
        "$mainUrl/anime/?genre%5B%5D=combat-sports" to "Combat Sports",
        "$mainUrl/anime/?genre%5B%5D=comedy" to "Comedy",
        "$mainUrl/anime/?genre%5B%5D=crossdressing" to "Crossdressing",
        "$mainUrl/anime/?genre%5B%5D=delinquents" to "Delinquents",
        "$mainUrl/anime/?genre%5B%5D=detective" to "Detective",
        "$mainUrl/anime/?genre%5B%5D=drama" to "Drama",
        "$mainUrl/anime/?genre%5B%5D=ecchi" to "Ecchi",
        "$mainUrl/anime/?genre%5B%5D=educational" to "Educational",
        "$mainUrl/anime/?genre%5B%5D=erotica" to "Erotica",
        "$mainUrl/anime/?genre%5B%5D=fantasy" to "Fantasy",
        "$mainUrl/anime/?genre%5B%5D=gag-humor" to "Gag Humor",
        "$mainUrl/anime/?genre%5B%5D=girls-love" to "Girls Love",
        "$mainUrl/anime/?genre%5B%5D=gore" to "Gore",
        "$mainUrl/anime/?genre%5B%5D=gourmet" to "Gourmet",
        "$mainUrl/anime/?genre%5B%5D=harem" to "Harem",
        "$mainUrl/anime/?genre%5B%5D=high-stakes-game" to "High Stakes Game",
        "$mainUrl/anime/?genre%5B%5D=historical" to "Historical",
        "$mainUrl/anime/?genre%5B%5D=horror" to "Horror",
        "$mainUrl/anime/?genre%5B%5D=idols-female" to "Idols (Female)",
        "$mainUrl/anime/?genre%5B%5D=idols-male" to "Idols (Male)",
        "$mainUrl/anime/?genre%5B%5D=isekai" to "Isekai",
        "$mainUrl/anime/?genre%5B%5D=iyashikei" to "Iyashikei",
        "$mainUrl/anime/?genre%5B%5D=josei" to "Josei",
        "$mainUrl/anime/?genre%5B%5D=kids" to "Kids",
        "$mainUrl/anime/?genre%5B%5D=love-polygon" to "Love Polygon",
        "$mainUrl/anime/?genre%5B%5D=love-status-quo" to "Love Status Quo",
        "$mainUrl/anime/?genre%5B%5D=magical-sex-shift" to "Magical Sex Shift",
        "$mainUrl/anime/?genre%5B%5D=mahou-shoujo" to "Mahou Shoujo",
        "$mainUrl/anime/?genre%5B%5D=martial-arts" to "Martial Arts",
        "$mainUrl/anime/?genre%5B%5D=mecha" to "Mecha",
        "$mainUrl/anime/?genre%5B%5D=medical" to "Medical",
        "$mainUrl/anime/?genre%5B%5D=military" to "Military",
        "$mainUrl/anime/?genre%5B%5D=music" to "Music",
        "$mainUrl/anime/?genre%5B%5D=mystery" to "Mystery",
        "$mainUrl/anime/?genre%5B%5D=mythology" to "Mythology",
        "$mainUrl/anime/?genre%5B%5D=organized-crime" to "Organized Crime",
        "$mainUrl/anime/?genre%5B%5D=otaku-culture" to "Otaku Culture",
        "$mainUrl/anime/?genre%5B%5D=parody" to "Parody",
        "$mainUrl/anime/?genre%5B%5D=performing-arts" to "Performing Arts",
        "$mainUrl/anime/?genre%5B%5D=pets" to "Pets",
        "$mainUrl/anime/?genre%5B%5D=psychological" to "Psychological",
        "$mainUrl/anime/?genre%5B%5D=racing" to "Racing",
        "$mainUrl/anime/?genre%5B%5D=reincarnation" to "Reincarnation",
        "$mainUrl/anime/?genre%5B%5D=reverse-harem" to "Reverse Harem",
        "$mainUrl/anime/?genre%5B%5D=romance" to "Romance",
        "$mainUrl/anime/?genre%5B%5D=romantic-subtext" to "Romantic Subtext",
        "$mainUrl/anime/?genre%5B%5D=samurai" to "Samurai",
        "$mainUrl/anime/?genre%5B%5D=school" to "School",
        "$mainUrl/anime/?genre%5B%5D=sci-fi" to "Sci-Fi",
        "$mainUrl/anime/?genre%5B%5D=seinen" to "Seinen",
        "$mainUrl/anime/?genre%5B%5D=shoujo" to "Shoujo",
        "$mainUrl/anime/?genre%5B%5D=shounen" to "Shounen",
        "$mainUrl/anime/?genre%5B%5D=showbiz" to "Showbiz",
        "$mainUrl/anime/?genre%5B%5D=slice-of-life" to "Slice of Life",
        "$mainUrl/anime/?genre%5B%5D=space" to "Space",
        "$mainUrl/anime/?genre%5B%5D=sports" to "Sports",
        "$mainUrl/anime/?genre%5B%5D=strategy-game" to "Strategy Game",
        "$mainUrl/anime/?genre%5B%5D=super-power" to "Super Power",
        "$mainUrl/anime/?genre%5B%5D=supernatural" to "Supernatural",
        "$mainUrl/anime/?genre%5B%5D=survival" to "Survival",
        "$mainUrl/anime/?genre%5B%5D=suspense" to "Suspense",
        "$mainUrl/anime/?genre%5B%5D=team-sports" to "Team Sports",
        "$mainUrl/anime/?genre%5B%5D=time-travel" to "Time Travel",
        "$mainUrl/anime/?genre%5B%5D=urban-fantasy" to "Urban Fantasy",
        "$mainUrl/anime/?genre%5B%5D=vampire" to "Vampire",
        "$mainUrl/anime/?genre%5B%5D=video-game" to "Video Game",
        "$mainUrl/anime/?genre%5B%5D=villainess" to "Villainess",
        "$mainUrl/anime/?genre%5B%5D=visual-arts" to "Visual Arts",
        "$mainUrl/anime/?genre%5B%5D=workplace" to "Workplace"
    )
